...
| [Google Antigravity](https://cloud.google.com/vertex-ai) | `GOOGLE_CLOUD_API_KEY` | Vertex AI models |
| [Qwen](https://qwen.ai) | — | Alibaba's Qwen |
| [MiniMax](https://minimaxi.com) | — | MiniMax models |
| [Pi AI](https://pi.ai) | `ELIZA_USE_PI_AI` | Inflection Pi |
| [Zai](https://homunculuslabs.com) | `ZAI_API_KEY` | Homunculus Labs |
