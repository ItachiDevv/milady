...
| [Google Antigravity](https://cloud.google.com/vertex-ai) | `GOOGLE_CLOUD_API_KEY` | vertex AI / google cloud |
...
| [Qwen](https://qwen.ai) | — | alibaba's qwen models |
| [MiniMax](https://minimaxi.com) | — | minimax language models |
| [Pi AI](https://pi.ai) | `ELIZA_USE_PI_AI` | inflection pi, conversational |
| [Zai](https://homunculuslabs.com) | `ZAI_API_KEY` | homunculus labs inference |
