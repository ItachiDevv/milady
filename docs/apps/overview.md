...
description: Milady ships as a cross-platform suite for desktop, mobile, and web dashboard workflows in release v2.0.0-alpha.116.
---

Milady is available across the primary shipped platforms in release `v2.0.0-alpha.116`. Each app connects to the same agent runtime, giving you a consistent experience whether you're at your desk or on your phone.
