...
- **Shell plugin** (`@elizaos/plugin-shell`) -- provides shell command execution actions (core plugin, always loaded)
- **Commands plugin** (`@elizaos/plugin-commands`) -- provides slash command handling (core plugin, always loaded)
