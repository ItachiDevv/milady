...
The Browser Relay extension remains documented as a separate or planned distribution. It is not part of the shipped `v2.0.0-alpha.116` repository surface, and its documentation now serves only as a release-status page plus architecture notes.
