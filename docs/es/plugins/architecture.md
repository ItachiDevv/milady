...
Plugins como `@elizaos/plugin-directives`, `@elizaos/plugin-mcp`, `@elizaos/plugin-scratchpad` y `@elizaos/plugin-scheduling` están comentados en el código fuente y podrían activarse en versiones futuras.
