    ...
    services:
      milady-gateway:
        ...
        ports:
          ...
          - "${MILADY_WECHAT_WEBHOOK_PORT:-18790}:18790"
        init: true
...
| 18790 | WeChat webhook callback server | Host-mapped | `MILADY_WECHAT_WEBHOOK_PORT` |
...
| `MILADY_WECHAT_WEBHOOK_PORT` | `18790` | Host port for the WeChat webhook callback server |
