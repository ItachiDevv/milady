...
> **Note:** `@elizaos/plugin-secrets-manager`, `@elizaos/plugin-rolodex`, `@elizaos/plugin-plugin-manager`, `@elizaos/plugin-trust`, `@elizaos/plugin-todo`, `@elizaos/plugin-personality`, and `@elizaos/plugin-experience` are commented out in the core plugins array and may be re-enabled in a future release.
...
Plugins such as `@elizaos/plugin-directives`, `@elizaos/plugin-mcp`, `@elizaos/plugin-scheduling`, and `@elizaos/plugin-scratchpad` are commented out in the optional core list and may be activated in future releases.
