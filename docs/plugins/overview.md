...
<Card title="Core Plugins" icon="cube" href="/plugin-registry/knowledge">
  Essential plugins that ship with every Milady installation — sql, local-embedding, form, knowledge, trajectory-logger, agent-orchestrator, cron, shell, commands, agent-skills, and roles.
</Card>
