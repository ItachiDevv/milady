...
<Card title="Core Plugins" icon="cube" href="/plugin-registry/knowledge">
  Essential plugins that ship with every Milady installation — sql, local-embedding, knowledge, form, cron, shell, agent-skills, trajectory-logger, and agent-orchestrator.
</Card>
