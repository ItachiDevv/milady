...
This displays common environment variable names and configuration guidance for model providers. It is a read-only reference -- it does not modify any files.
