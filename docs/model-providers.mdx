...
|----------|----------------|------------------|---------|-------|
| [Anthropic](https://anthropic.com) | `@elizaos/plugin-anthropic` | `ANTHROPIC_API_KEY` or `CLAUDE_API_KEY` | Yes | **Recommended.** Claude models (Opus, Sonnet, Haiku). |
| [OpenAI](https://openai.com) | `@elizaos/plugin-openai` | `OPENAI_API_KEY` | Yes | GPT-4o, o1, o3, GPT-4.1. |
| [Google Gemini](https://ai.google.dev) | `@elizaos/plugin-google-genai` | `GOOGLE_API_KEY` or `GOOGLE_GENERATIVE_AI_API_KEY` | Yes | Gemini Pro, Flash, Ultra. |
...
| [Groq](https://groq.com) | `@elizaos/plugin-groq` | `GROQ_API_KEY` | No | Ultra-fast inference (LPU). Installed on demand. |
...
| `ZAI_API_KEY` | Zai |
| `ELIZA_USE_PI_AI` or `MILADY_USE_PI_AI` | Pi AI |
